...
definition ONE4() returns uint256 = 10000;
definition ONE8() returns uint256 = 100000000;
...
function mulDivNearestAbstractPlus(uint256 x, uint256 y, uint256 z) returns uint256 {
    ...
    require to_mathint(xy + halfZ) >= to_mathint(fz);
    require fz + z > to_mathint(xy) + halfZ;
    return res; 
}

// For self checks - converts all assumptions in mulDivNearestAbstractPlus() to assertion
function mulDivNearestAbstractPlus_assertions(uint256 x, uint256 y, uint256 z, uint256 res) {
    ...
    assert to_mathint(xy + halfZ) >= to_mathint(fz);
    assert fz + z > to_mathint(xy) + halfZ;
}
...
// USD mul and div
//
function mulDownUSD(uint256 x, uint256 y) returns uint256 {
    return mulDivDownAbstractPlus(x, y, ONE8());
}

function mulUpUSD(uint256 x, uint256 y) returns uint256 {
    return mulDivUpAbstractPlus(x, y, ONE8());
}

function mulNearestUSD(uint256 x, uint256 y) returns uint256 {
    return mulDivNearestAbstractPlus(x, y, ONE8());
}

function divDownUSD(uint256 x, uint256 y) returns uint256 {
    return mulDivDownAbstractPlus(x, ONE8(), y);
}

function divUpUSD(uint256 x, uint256 y) returns uint256 {
    return mulDivUpAbstractPlus(x, ONE8(), y);
}

function divNearestUSD(uint256 x, uint256 y) returns uint256 {
    return mulDivNearestAbstractPlus(x, ONE8(), y);
}

function mulNearestUSD_assertions(uint256 x, uint256 y, uint256 res) {
    mulDivNearestAbstractPlus_assertions(x, y, ONE8(), res);
}

function divNearestUSD_assertions(uint256 x, uint256 y, uint256 res) {
    mulDivNearestAbstractPlus_assertions(x, ONE8(), y, res);
}

//
// USD mul and div
//
function mulNearestPercent(uint256 x, uint256 y) returns uint256 {
    return mulDivNearestAbstractPlus(x, y, ONE4());
}

function divNearestPercent(uint256 x, uint256 y) returns uint256 {
